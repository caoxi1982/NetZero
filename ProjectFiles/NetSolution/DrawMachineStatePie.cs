...
public class DrawMachineStatePie : BaseNetLogic
{
    ...
    public void UpdatePie()
    {
       ...
       // Clean for float and double data types, might be useless in this case
        ...
        tables.ForEach(table =>
        {
            ...
            {
               // Log.Info($"{record.GetValueByKey("Energy")} : {record.GetValueByKey($"{equip_Prod}")}");                
               if (dataValues == "")
                {
        ...
        //Log.Info(dataValues);
        Log.Info("Drawing Consumption Pie Chart.");
